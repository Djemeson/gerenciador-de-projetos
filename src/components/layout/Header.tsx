  ...
  return (
    <div className="flex items-center justify-between px-6 py-3.5 bg-gray-50/50 backdrop-blur-md border-b border-gray-200/60 flex-shrink-0 z-40 relative">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden sm:flex items-center gap-1.5 bg-gradient-to-r from-brand-50 to-brand-50/50 border border-brand-100/60 px-3 py-1 rounded-full shadow-[0_1px_2px_rgba(0,0,0,0.01)]">
        ...
        <div className="flex items-center gap-2 pl-1 border-l border-gray-200/80">
          ...
          <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-brand-500 to-brand-600 text-white font-bold text-xs flex items-center justify-center shadow-sm select-none hover:shadow-md transition-all duration-200">
            DJ
          </div>
        </div>
      </div>
