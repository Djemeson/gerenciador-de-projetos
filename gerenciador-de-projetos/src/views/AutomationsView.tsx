...
export function AutomationsView() {
  const { automations, projects, addAutomation, toggleAutomation, deleteAutomation } = useAppStore()
          ...
          <div className="grid grid-cols-2 gap-3 mb-3">
            ...
            <div>
              ...
              <select value={form.projectId} onChange={e=>setForm(f=>({...f,projectId:e.target.value}))}
                className="w-full text-xs px-2 py-1.5 border border-gray-200 rounded-lg outline-none bg-white cursor-pointer">
